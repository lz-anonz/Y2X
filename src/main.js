...
const autoloader_version = "v1.0.0";
...
(async function() {
    ...
    window.autoloader_ui = function() {
        ...
        autoloader_ui.style.zoom = scale;
        autoloader_ui.style.transformOrigin = "top left";
        autoloader_ui.style.zIndex = "9999";
        autoloader_ui.style.background = "radial-gradient(circle at top, #1b1b1b 0%, #050505 70%)";
        ...
        topBar.style.padding = "0 40px";
        topBar.style.margin = "0 auto";
        topBar.style.boxSizing = "border-box";
        topBar.style.background = "linear-gradient(90deg, rgba(255,0,90,0.12), rgba(0,0,0,0.15))";
        topBar.style.borderBottom = "1px solid rgba(255,255,255,0.06)";
        topBar.style.backdropFilter = "blur(10px)";

        // BRAND
        const brand = document.createElement("div");
        brand.textContent = "Y2JB Autoloader";
        brand.style.fontSize = "34px";
        brand.style.fontWeight = "900";
        brand.style.letterSpacing = "6px";
        brand.style.color = "#ffffff";
        brand.style.textShadow = "0 0 18px rgba(255,0,90,0.5)";

        // VERSION
        const version = document.createElement("div");
        version.textContent = "Y2X " + autoloader_version;
        version.style.color = "#777";
        version.style.fontSize = "18px";
        version.style.letterSpacing = "2px";
        ...
        panel.style.boxShadow = `0 0 45px rgba(0,0,0,0.7), inset 0 0 20px rgba(255,255,255,0.02)`;
        ...
        subtitle.textContent = "⏳P2JB/LAPSE EXPLOIT⏳";
        ...
        progressBarContainer.style.borderRadius = "50px";
        ...
        progressBar.style.transition = "transform 0.45s ease-in-out";
        progressBar.style.background = "linear-gradient(90deg, #ff0055, #ff5500)";
        ...
        footer.style.letterSpacing = "3px";
    ...
    window.uiLog = function(message, type="info") {
        ...
        if (logContainer) {
            ...
            logEntry.style.padding = "14px 18px";
